...
//		try {
//			//sinds File dir = new File(peerID);
//			//sinds dir.mkdir();
//
//			//sinds File newfile = new File(peerID, CommonProperties.fileName);
//
//			File directory = new File(peerID);
//			File newfile = new File(peerID,Comm);
//			//sinds OutputStream os = new FileOutputStream(newfile, true);
